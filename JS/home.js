window.onload = function(){
  ...
  document.querySelector('.contenedor-albumes').innerHTML = '<img class="loading" src="../img/loading gif.gif" alt="gif"></img> '
  //////// ALBUMES
  ...
  document.querySelector('.contenedor-artistas').innerHTML = '<img class="loading" src="../img/loading gif.gif" alt="gif"></img> '
  ///////////// Artistas
  ...
  .then(function(information) {
    ...
    document.querySelector('.contenedor-tracks').innerHTML = '<img class="loading" src="../img/loading gif.gif" alt="gif"></img> '
  ///////////// TRACKS
